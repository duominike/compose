...
private fun formatStr(date: LocalDate, format: String): String{
  return DateTimeFormatter.ofPattern(format).format(date.toJavaLocalDate())
}


private fun formatDateTime(dateTime: LocalDateTime, format: String):String{
    return  dateTime.date.toJavaLocalDate().format(DateTimeFormatter.ofPattern(format))
}
